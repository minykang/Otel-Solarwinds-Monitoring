"""
app.py — 우리FISA 은행 API 서버 (Windows 네이티브 실행)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def salary_mode_control():
    """
    월급날 모드 ON/OFF
    POST {"active": true}  → 월급날 모드 켜기
    POST {"active": false} → 평상시 모드
    GET                    → 현재 상태 확인
    """
...
if __name__ == "__main__":
    logger.info("우리FISA 은행 API 서버 시작 (Windows 네이티브)")
